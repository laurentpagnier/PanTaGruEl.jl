function download_wri_data(source_folder)
    create_dir("$source_folder/wri")
    download("https://wri-dataportal-prod.s3.amazonaws.com/manual/global_power_plant_database_v_1_3.zip", "$source_folder/wri/global_power_plant.zip")
    run(`unzip -o $source_folder/wri/global_power_plant.zip -d $source_folder/wri/`)
end


l3_to_l2 = Dict("AFG" => "AF", "ALB" => "AL", "DZA" => "DZ",
"ASM" => "AS", "AND" => "AD", "AGO" => "AO", "AIA" => "AI", "ATA" => "AQ",
"ATG" => "AG", "ARG" => "AR", "ARM" => "AM", "ABW" => "AW", "AUS" => "AU",
"AUT" => "AT", "AZE" => "AZ", "BHS" => "BS", "BHR" => "BH", "BGD" => "BD",
"BRB" => "BB", "BLR" => "BY", "BEL" => "BE", "BLZ" => "BZ", "BEN" => "BJ",
"BMU" => "BM", "BTN" => "BT", "BOL" => "BO", "BES" => "BQ", "BIH" => "BA",
"BWA" => "BW", "BVT" => "BV", "BRA" => "BR", "IOT" => "IO", "BRN" => "BN",
"BGR" => "BG", "BFA" => "BF", "BDI" => "BI", "CPV" => "CV", "KHM" => "KH",
"CMR" => "CM", "CAN" => "CA", "CYM" => "KY", "CAF" => "CF", "TCD" => "TD",
"CHL" => "CL", "CHN" => "CN", "CXR" => "CX", "CCK" => "CC", "COL" => "CO",
"COM" => "KM", "COD" => "CD", "COG" => "CG", "COK" => "CK", "CRI" => "CR",
"HRV" => "HR", "CUB" => "CU", "CUW" => "CW", "CYP" => "CY", "CZE" => "CZ",
"CIV" => "CI", "DNK" => "DK", "DJI" => "DJ", "DMA" => "DM", "DOM" => "DO",
"ECU" => "EC", "EGY" => "EG", "SLV" => "SV", "GNQ" => "GQ", "ERI" => "ER",
"EST" => "EE", "SWZ" => "SZ", "ETH" => "ET", "FLK" => "FK", "FRO" => "FO",
"FJI" => "FJ", "FIN" => "FI", "FRA" => "FR", "GUF" => "GF", "PYF" => "PF",
"ATF" => "TF", "GAB" => "GA", "GMB" => "GM", "GEO" => "GE", "DEU" => "DE",
"GHA" => "GH", "GIB" => "GI", "GRC" => "GR", "GRL" => "GL", "GRD" => "GD",
"GLP" => "GP", "GUM" => "GU", "GTM" => "GT", "GGY" => "GG", "GIN" => "GN",
"GNB" => "GW", "GUY" => "GY", "HTI" => "HT", "HMD" => "HM", "VAT" => "VA",
"HND" => "HN", "HKG" => "HK", "HUN" => "HU", "ISL" => "IS", "IND" => "IN",
"IDN" => "ID", "IRN" => "IR", "IRQ" => "IQ", "IRL" => "IE", "IMN" => "IM",
"ISR" => "IL", "ITA" => "IT", "JAM" => "JM", "JPN" => "JP", "JEY" => "JE",
...
"GBR" => "GB", "UMI" => "UM", "USA" => "US", "URY" => "UY", "UZB" => "UZ",
"VUT" => "VU", "VEN" => "VE", "VNM" => "VN", "VGB" => "VG", "VIR" => "VI",
"WLF" => "WF", "ESH" => "EH", "YEM" => "YE", "ZMB" => "ZM", "ZWE" => "ZW",
"ALA" => "AX", "KOS" => "XK", "PR1" => "PT")

wri_type_to_simple = Dict("Hydro" => ("HY", "H"),
"Solar" => ("SO", "R"),
"Gas" => ("CG", "G"),
"Other" => ("OT", "O"),
"Oil" => ("FO", "F"),
...
function load_wri_data(source_folder)
    wri = DataFrame(CSV.File("$source_folder/wri/global_power_plant_database.csv"))
    wri.country =  wri.country .|> c -> l3_to_l2[c]
    rename!(wri, :capacity_mw => :capacity, :primary_fuel => :type)
    return wri[!,[ :name, :country, :type, :capacity, :latitude, :longitude]]
end
